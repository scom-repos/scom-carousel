...
import { IConfig, IData } from '@scom-carousel/global';
      ...
      >
        ...
        <i-panel>
          ...
          <i-input
            width="100%"
            value={item?.imageUrl || ''}
            onChanged={(source: Control) => this.updateList(source, lastIndex, 'imageUrl')}
          ></i-input>
        </i-panel>
        <i-panel>
          ...
          <i-input
            width="100%"
            value={item?.link || ''}
            onChanged={(source: Control) => this.updateList(source, lastIndex, 'link')}
          ></i-input>
        </i-panel>
      </i-vstack>
    );
